...
class TestGetRows:
    def test_get_rows(self, middle_page_parser):
        ...
        assert (
            data
            == '<img alt="@Aadhar4u" class="avatar mr-2 avatar-user" height="20" src="Network%20Dependents%20%C2%B7%20Delgan_loguru%20%C2%B7%20GitHub_files/88808890.jpg" width="20"/>'
        )
...
class TestGetNextPageUrl:
    def test_get_next_page_url(self, middle_page_parser):
        ...
        assert (
            data
            == "https://github.com/Delgan/loguru/network/dependents?dependents_after=MjE4MDQ2Mzc1NTc"
        )
